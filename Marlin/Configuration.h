...
#define STRING_CONFIG_H_AUTHOR "(mgamber, Paula's Ender 3 Pro w/ SKR E3 Turbo)" // Who made the changes.
 ...
 */
//MRG//#define S_CURVE_ACCELERATION
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -16, -3.400 }
